...
def feature_extraction2(df_meta, df):
...
if 'name' == 'main':
    ...
    train_passband_agg, train_object_agg = feature_extraction2(train_meta, train)
    ...
    test_passband_agg, test_object_agg = feature_extraction2(test_meta, test)
